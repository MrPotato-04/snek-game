    ...
    for (let x = 0; x < GRID_WIDTH; x++) {
        for (let y = 0; y < (GRID_HEIGTH); y++) {
            ...
            if (y === 0 || y === GRID_HEIGTH - 1) {
                // 
                if (RandomNumber[index] === 2 && portalcount < 1 && x != 0 && x != GRID_WIDTH -1 && y !== GRID_HEIGTH - 1) {
                    chunk.classList.add(`portal`)
                    portalcount++
                } else if (y === GRID_HEIGTH - 1 || y === 0)  {
                    if (y === 0 && x === 0) {
                        ...
                        chunk.classList.add(`waterBorder`)
                    } else if(y === GRID_HEIGTH - 1 && x === 0){
                        chunk.classList.add(`chunkCorner3`)
                        chunk.classList.add(`waterBorder`)
                    }else if (y === GRID_HEIGTH - 1 && x === GRID_WIDTH - 1){
                        chunk.classList.add(`chunkCorner4`)
                        chunk.classList.add(`waterBorder`)
                    }else{
                ...
                if (x === GRID_HEIGTH - 1 && y === (GRID_WIDTH - 1)) {
                    chunk.classList.add(`chunkCorner2`)
                    chunk.classList.add(`waterBorder`)
                } else if (x === 0) {
